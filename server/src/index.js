...
app.get('/api/menu', (req, res) => {
  ...
  ok(res, { ...m, settings: { cafe_name: s.cafe_name, tax_gst: s.tax_gst, tax_qst: s.tax_qst, currency: s.currency, default_lang: s.default_lang,
    ask_customer_name: s.ask_customer_name, ask_service_type: s.ask_service_type, thank_you_seconds: s.thank_you_seconds, logo_url: s.logo_url, welcome_image: s.welcome_image || '',
